...
public class Curtain : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            m_feltBlock_L.gameObject.SetActive(false); // 自分を非アクティブにする
            // 右側にフェルトブロックがある場合はそこに所属させる
